...
public abstract class Hilt_ArtFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_ArtFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((ArtFragment_GeneratedInjector) generatedComponent()).injectArtFragment(UnsafeCasts.<ArtFragment>unsafeCast(this));
  }
